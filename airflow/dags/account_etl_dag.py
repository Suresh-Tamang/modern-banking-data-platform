...
with DAG(
    ...
    execute_account_etl = BashOperator(
        task_id='execute_account_etl_command',
        bash_command='docker exec python_etl bash -c "python -m src.account_main --source api --load-mode copy"',
